...
public class LoggingHandler implements InvocationHandler {
	...
	public Object invoke(Object proxy, Method method, Object[] args) 
																								throws Throwable {
		System.out.println("\n=====================================");
		System.out.println("1[LOG] "+getClass()+".invoke() start.....");
		System.out.println("2[LOG] Target Object 호출 할 method :"+method);
		if(args != null){
			System.out.println("3[LOG] Target Object 호출 할 method에 전달되는 인자 : "+args[0]);
		}
		...
		try {
			...
			System.out.println("6[LOG] "+getClass()+".invoke() end.....");
			System.out.println("=====================================\n");
		}
	}
